...
#define BASS_IOSNOTIFY_INTERRUPT_END	2	// interruption ended
	...
	{
		return reinterpret_cast<BOOL(__stdcall*)(DWORD, DWORD)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_SetConfig")))(option, value);
	}

	inline DWORD BASS_GetConfig(DWORD option)
	{
		return reinterpret_cast<DWORD(__stdcall*)(DWORD)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_GetConfig")))(option);
	}
	...
	{
		return reinterpret_cast<DWORD(__stdcall*)()>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_GetVersion")))();
	}
	int BASSDEF(BASS_ErrorGetCode)();
	BOOL BASSDEF(BASS_GetDeviceInfo)(DWORD pdevice, BASS_DEVICEINFO *info);
#if defined(_WIN32) && !defined(_WIN32_WCE) && !(WINAPI_FAMILY && WINAPI_FAMILY!=WINAPI_FAMILY_DESKTOP_APP)
	inline BOOL BASS_Init(int pdevice, DWORD freq, DWORD flags, HWND win, const GUID *dsguid)
	{
		return reinterpret_cast<BOOL(__stdcall*)(int pdevice, DWORD freq, DWORD flags, HWND win, const GUID *dsguid)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_Init")))(pdevice, freq, flags, win, dsguid);
	}

#else
	BOOL BASSDEF(BASS_Init)(int device, DWORD freq, DWORD flags, void *win, void *dsguid);
#endif
	BOOL BASSDEF(BASS_SetDevice)(DWORD pdevice);
	DWORD BASSDEF(BASS_GetDevice)();
	inline BOOL BASS_Free()
	{
		return reinterpret_cast<BOOL(__stdcall*)()>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_Free")))();
	}
#if defined(_WIN32) && !defined(_WIN32_WCE) && !(WINAPI_FAMILY && WINAPI_FAMILY!=WINAPI_FAMILY_DESKTOP_APP)
	...
	{
		return reinterpret_cast<BOOL(__stdcall*)()>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_Start")))();
	}
	inline BOOL BASS_Stop()
	{
		return reinterpret_cast<BOOL(__stdcall*)()>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_Stop")))();
	}
	inline BOOL BASS_Pause()
	{
		return reinterpret_cast<BOOL(__stdcall*)()>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_Pause")))();
	}
	inline BOOL BASS_SetVolume(float volume)
	{
		return reinterpret_cast<BOOL(__stdcall*)(float volume)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_SetVolume")))(volume);
	}
	inline float BASS_GetVolume()
	{
		return reinterpret_cast<float(__stdcall*)()>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_GetVolume")))();
	}
	...
	{
		return reinterpret_cast<HSTREAM(__stdcall*)(BOOL mem, const void *file, QWORD offset, QWORD length, DWORD flags)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_StreamCreateFile")))(mem, file, offset, length, flags);
	}

	inline HSTREAM BASS_StreamCreateURL(const char *url, DWORD offset, DWORD flags, DOWNLOADPROC *proc, void *user)
	{
		return reinterpret_cast<HSTREAM(__stdcall*)(const char *url, DWORD offset, DWORD flags, DOWNLOADPROC *proc, void *user)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_StreamCreateURL")))(url, offset, flags, proc, user);
	}
	...
	{
		return reinterpret_cast<BOOL(__stdcall*)(HSTREAM handle)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_StreamFree")))(handle);
	}

	inline QWORD BASS_StreamGetFilePosition(HSTREAM handle, DWORD mode)
	{
		return reinterpret_cast<QWORD(__stdcall*)(HSTREAM handle, DWORD mode)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_StreamGetFilePosition")))(handle, mode);
	}
	...
	BOOL BASSDEF(BASS_RecordGetDeviceInfo)(DWORD pdevice, BASS_DEVICEINFO *info);
	BOOL BASSDEF(BASS_RecordInit)(int pdevice);
	BOOL BASSDEF(BASS_RecordSetDevice)(DWORD pdevice);
	...
	BOOL BASSDEF(BASS_ChannelSetDevice)(DWORD handle, DWORD pdevice);
	...
	{
		return reinterpret_cast<const char *(__stdcall*)(DWORD handle, DWORD tags)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_ChannelGetTags")))(handle, tags);
	}
	...
	{
		return reinterpret_cast<BOOL(__stdcall*)(DWORD handle, BOOL restart)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_ChannelPlay")))(handle, restart);
	}
	BOOL BASSDEF(BASS_ChannelStop)(DWORD handle);
	BOOL BASSDEF(BASS_ChannelPause)(DWORD handle);
	inline BOOL BASS_ChannelSetAttribute(DWORD handle, DWORD attrib, float value)
	{
		return reinterpret_cast<BOOL(__stdcall*)(DWORD handle, DWORD attrib, float value)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_ChannelSetAttribute")))(handle, attrib, value);
	}
	...
	{
		return reinterpret_cast<HSYNC(__stdcall*)(DWORD handle, DWORD type, QWORD param, SYNCPROC *proc, void *user)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_ChannelSetSync")))(handle, type, param, proc, user);
	}
