...
public:
	struct animation
	{
		...
		bool is_valid(float sim_time, bool this_valid, float range);
...
public:
	...
	std::optional<animation*> get_latest_up_pitch_animation(c_cs_player* player);
	std::optional<animation*> get_latest_sideways_animation(c_cs_player* player);
