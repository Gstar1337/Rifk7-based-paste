...
class c_esp
{
	struct player_info
	{
		...
		matrix3x4 bones[128]{};
		bool good_bones{};
		bool has_kevlar{}, has_helmet{}, is_defusing{}, is_scoped{}, shots_missed{}, resolver_mode{};
...
private:
	...
	static void esp_player_flags(player_info& player, const c_vector2d& from, const float width, const float height, const c_color& color);
	...
	static void esp_weapon(player_info& player, const c_vector2d& from, const float width, const float height, const c_color& color, bool draw_ammo);
