...
struct c_incoming_sequence
{
	c_incoming_sequence::c_incoming_sequence(int instate, int OutSequenceNr, int outrel, int seqnr, float time)
	{
...
public:
	...
	inline static std::deque<c_incoming_sequence>sequences;//mutiny
	inline static void update_incoming_sequences(c_net_channel* channel);
