...
public:
	...
	bool is_grenade() { return get_item_definition() >= WEAPON_FLASHBANG && get_item_definition() <= WEAPON_INC; }
	...
	vfunc(481, get_inaccuracy(), float(__thiscall*)(void*))()
	vfunc(482, update_accuracy(), void(__thiscall*)(void*))()
